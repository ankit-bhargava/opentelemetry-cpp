...
TEST(Counter, StressAdd){
  ...
  EXPECT_EQ(std::dynamic_pointer_cast<BoundCounter<int>>(alpha->boundInstruments_[KvToString(labelkv)])->GetAggregator()->get_values()[0], 200000);
  EXPECT_EQ(std::dynamic_pointer_cast<BoundCounter<int>>(alpha->boundInstruments_[KvToString(labelkv1)])->GetAggregator()->get_values()[0], 300000);
}
...
TEST(IntUpDownCounter, StressAdd){
  ...
  EXPECT_EQ(std::dynamic_pointer_cast<BoundUpDownCounter<int>>(alpha->boundInstruments_[KvToString(labelkv)])->GetAggregator()->get_values()[0], 123400*2);
  EXPECT_EQ(std::dynamic_pointer_cast<BoundUpDownCounter<int>>(alpha->boundInstruments_[KvToString(labelkv1)])->GetAggregator()->get_values()[0], 567800-123400);
}
...
TEST(IntValueRecorder, StressRecord){
  ...
  EXPECT_EQ(std::dynamic_pointer_cast<BoundValueRecorder<int>>(alpha->boundInstruments_[KvToString(labelkv)])->GetAggregator()->get_values()[0], 0); // min
  EXPECT_EQ(std::dynamic_pointer_cast<BoundValueRecorder<int>>(alpha->boundInstruments_[KvToString(labelkv)])->GetAggregator()->get_values()[1], 49); // max
  EXPECT_EQ(std::dynamic_pointer_cast<BoundValueRecorder<int>>(alpha->boundInstruments_[KvToString(labelkv)])->GetAggregator()->get_values()[2], 1525); // sum
  EXPECT_EQ(std::dynamic_pointer_cast<BoundValueRecorder<int>>(alpha->boundInstruments_[KvToString(labelkv)])->GetAggregator()->get_values()[3], 75); // count

    EXPECT_EQ(std::dynamic_pointer_cast<BoundValueRecorder<int>>(alpha->boundInstruments_[KvToString(labelkv1)])->GetAggregator()->get_values()[0], -99); // min
    EXPECT_EQ(std::dynamic_pointer_cast<BoundValueRecorder<int>>(alpha->boundInstruments_[KvToString(labelkv1)])->GetAggregator()->get_values()[1], 24); // max
    EXPECT_EQ(std::dynamic_pointer_cast<BoundValueRecorder<int>>(alpha->boundInstruments_[KvToString(labelkv1)])->GetAggregator()->get_values()[2], -4650); // sum
    EXPECT_EQ(std::dynamic_pointer_cast<BoundValueRecorder<int>>(alpha->boundInstruments_[KvToString(labelkv1)])->GetAggregator()->get_values()[3], 125); // count
}
