...
TEST(Controller, Constructor)
{
    ...
    PushController alpha(meter, std::unique_ptr<MetricsExporter> (new
    opentelemetry::exporter::metrics::OStreamMetricsExporter), std::shared_ptr<Processor>(new Processor()), 5);
}
